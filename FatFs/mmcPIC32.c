...
#define CS_SETOUT() TRISGbits.TRISG15 = 0
#define CS_LOW()  _LATG15 = 0	/* MMC CS = L */
#define CS_HIGH() _LATG15 = 1	/* MMC CS = H */
...
#define	FCLK_FAST()	SPIBRG = 15		/* Set fast clock (depends on the CSD) */
